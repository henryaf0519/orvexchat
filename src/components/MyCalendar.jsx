...
// 🎨 PALETA "FRESH & SOFT" (Verdes, Azules, Amarillos y más)
const COLOR_PALETTE = [
  // 1. AZUL CIELO (Clásico, limpio)
  { bg: '#eff6ff', border: '#3b82f6', text: '#1e40af' }, 
  
  // 2. ESMERALDA (Verde menta, muy fresco)
  { bg: '#ecfdf5', border: '#10b981', text: '#047857' }, 
  
  // 3. ÁMBAR (Amarillo cálido, no chillón)
